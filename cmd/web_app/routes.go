...
func (app *application) routes() http.Handler {
	...
	//nosurf for CSRF i.e place hidden token in form to ensure request is made through the website.
	//authenticate -> checks for session set with authentication id. if yes, get user, set context to is authenticated. if no continue.
	mux := pat.New()
